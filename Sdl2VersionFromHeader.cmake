...
# SDL2_version_from_header(header_file)
#   sets SDL2(_(IMAGE|MIXER|NET|RTF|TTF))_VERSION in the parent scope
#
#   header_file (string): expecting one of SDL_version.h, SDL_image.h, SDL_mixer.h,
#     SDL_net.h, SDL_rtf.h, or SDL_ttf.h
#
function(SDL2_version_from_header
    header_file
  )
  set(var_prefix   "SDL2")
  ...
  elseif(NOT header_file STREQUAL "SDL_version.h")
    message(WARNING "Unexpected SDL2 header file name: ${header_file}, could \
not resolve ${var_prefix}_VERSION")
  endif()
...
could not resolve ${var_prefix}_VERSION")
  ...
  message(STATUS
    "${var_prefix}_VERSION derived from ${${var_prefix}_INCLUDE_DIR}/${header_file} \
as ${${var_prefix}_VERSION}")
